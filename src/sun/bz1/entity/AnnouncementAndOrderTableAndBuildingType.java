...
/**
 * 维修公告表(发布公告时在该表中添加数据，公告结束时修改公告状态)、维修单表、建筑类型表
 * 
 * 实体类
 * 
...
public class AnnouncementAndOrderTableAndBuildingType {
	...
	/**
	 * 维修公告表-维修公告ID(WXGG+UUID)
	 */
    private String announcementid;
    
    /**
	 * 维修公告表-维修单ID(D+年月日+时分秒+6位随机数)
	 */
	private String orderid;

    /**
	 * 维修公告表-维修公告状态(Y:进行中/N:已完成)
	 */
	...
	public void setAnnouncementremark(String announcementremark) {
		this.announcementremark = announcementremark;
	}
	...
	public String getSnatchOrNo() {
		return snatchOrNo;
	}

	public void setSnatchOrNo(String snatchOrNo) {
		this.snatchOrNo = snatchOrNo;
	}
