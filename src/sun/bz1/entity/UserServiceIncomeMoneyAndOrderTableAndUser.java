...
/**
 * 用户_维修工、安装队_收入_金额表、维修单表、金额用户(用户表)
 * 
 * 实体类
 * 
...
public class UserServiceIncomeMoneyAndOrderTableAndUser {

	/**
	 * 用户_维修工、安装队_收入_金额表-序号(自增主键)
	 */
	private Integer id;

	/**
	 * 用户_维修工、安装队_收入_金额表-维修人员收入金额ID(WXSR+UUID)
	 */
	private String userserviceincomemoneyid;

	/**
	 * 用户_维修工、安装队_收入_金额表-维修单ID(D+年月日+时分秒+6位随机数)
	 */
	private String orderid;

	/**
	 * 用户_维修工、安装队_收入_金额表-金额用户ID(YHBG+UUID)
	 */
	private String userserviceincomemoneyuserid;

	/**
	 * 用户_维修工、安装队_收入_金额表-金额(可正可负)
	 */
	private Double userserviceincomemoney;

	/**
	 * 用户_维修工、安装队_收入_金额表-金额来源(QRQXWX:确认取消(维修人员收入金额)/YSHG:验收合格(维修人员收入金额)/PTXTWX:平台协调(维修人员收入金额)/WXCZ:维修人员充值(维修人员收入金额))
	 */
	private String userserviceincomemoneysource;

	/**
	 * 用户_维修工、安装队_收入_金额表-金额创建时间
	 */
	private Date userserviceincomemoneycreatetime;

	/**
	 * 用户_维修工、安装队_收入_金额表-金额其他字段1
	 */
	private String userserviceincomemoneyother1;

	/**
	 * 用户_维修工、安装队_收入_金额表-金额其他字段2
	 */
	private String userserviceincomemoneyother2;

	/**
	 * 用户_维修工、安装队_收入_金额表-金额备注
	 */
	...
	public void setUserserviceincomemoneyid(String userserviceincomemoneyid) {
		this.userserviceincomemoneyid = userserviceincomemoneyid;
	}
	...
	public void setUserserviceincomemoneyuserid(String userserviceincomemoneyuserid) {
		this.userserviceincomemoneyuserid = userserviceincomemoneyuserid;
	}
	...
	public void setUserserviceincomemoneysource(String userserviceincomemoneysource) {
		this.userserviceincomemoneysource = userserviceincomemoneysource;
	}

	@JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+08:00")
	public Date getUserserviceincomemoneycreatetime() {
	...
	public void setUserserviceincomemoneyother1(String userserviceincomemoneyother1) {
		this.userserviceincomemoneyother1 = userserviceincomemoneyother1;
	}
	...
	public void setUserserviceincomemoneyother2(String userserviceincomemoneyother2) {
		this.userserviceincomemoneyother2 = userserviceincomemoneyother2;
	}
	...
	public void setUserserviceincomemoneyremark(String userserviceincomemoneyremark) {
		this.userserviceincomemoneyremark = userserviceincomemoneyremark;
	}
