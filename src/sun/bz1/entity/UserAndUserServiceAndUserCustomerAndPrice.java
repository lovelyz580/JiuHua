 ...
 * 实体类
 * 
 * @author ZY on 2019/01/16
 */

public class UserAndUserServiceAndUserCustomerAndPrice implements Comparable<UserAndUserServiceAndUserCustomerAndPrice> {
	 ...
	 */
	@Override
	public int compareTo(UserAndUserServiceAndUserCustomerAndPrice user) {
