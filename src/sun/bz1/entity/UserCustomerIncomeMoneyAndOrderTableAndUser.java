...
public class UserCustomerIncomeMoneyAndOrderTableAndUser {

	/**
	 * 用户_客户_收入_金额表-序号(自增主键)
	 */
    private Integer id;

    /**
	 * 用户_客户_收入_金额表-客户收入金额ID(KHSR+UUID)
	 */
    private String usercustomerincomemoneyid;

    /**
	 * 用户_客户_收入_金额表-维修单ID(D+年月日+时分秒+6位随机数)
	 */
    private String orderid;

    /**
	 * 用户_客户_收入_金额表-金额用户ID(YHBG+UUID)
	 */
    private String usercustomerincomemoneyuserid;

    /**
	 * 用户_客户_收入_金额表-金额(可正可负)
	 */
    private Double usercustomerincomemoney;

    /**
	 * 用户_客户_收入_金额表-金额来源(WXTH:维修人员退回(客户收入金额)/QRQXKH:确认取消(客户收入金额)/GHWX:更换维修人员(客户收入金额)/WTPD:委托平台派单(客户收入金额)/PTXTKH:平台协调(客户收入金额)/KHCZ:客户充值(客户收入金额))
	 */
	...
	public void setUsercustomerincomemoneyid(String usercustomerincomemoneyid) {
		this.usercustomerincomemoneyid = usercustomerincomemoneyid;
	}
	...
	public void setUsercustomerincomemoneyuserid(String usercustomerincomemoneyuserid) {
		this.usercustomerincomemoneyuserid = usercustomerincomemoneyuserid;
	}
	...
	public void setUsercustomerincomemoneysource(String usercustomerincomemoneysource) {
		this.usercustomerincomemoneysource = usercustomerincomemoneysource;
	}
	...
	public void setUsercustomerincomemoneyother1(String usercustomerincomemoneyother1) {
		this.usercustomerincomemoneyother1 = usercustomerincomemoneyother1;
	}
	...
	public void setUsercustomerincomemoneyother2(String usercustomerincomemoneyother2) {
		this.usercustomerincomemoneyother2 = usercustomerincomemoneyother2;
	}
	...
	public void setUsercustomerincomemoneyremark(String usercustomerincomemoneyremark) {
		this.usercustomerincomemoneyremark = usercustomerincomemoneyremark;
	}
