...
/**
 * 维修人员退回维修单表(维修人员退回维修单时在该表中添加数据)、维修单表、维修退回人员(用户表)
 * 
 * 实体类
 * 
...
public class ReturnTableAndOrderTableAndUser {
	...
	/**
	 * 维修人员退回维修单表-维修退回ID(WXTH+UUID)
	 */
	private String returnid;

	/**
	 * 维修人员退回维修单表-维修单ID(D+年月日+时分秒+6位随机数)
	 */
	private String orderid;

	/**
	 * 维修人员退回维修单表-维修退回内容(原因)
	 */
	private String returncontent;

	/**
	 * 维修人员退回维修单表-维修退回人ID(YHBG+UUID)
	 */
	...
	/**
	 * 维修退回人员(用户表)-用户身份类别(KH:客户/WX:维修工/AZ:安装队)(会有多个，以逗号分隔，以逗号结尾)
	 */
	private String userrole;

	/**
	 * 维修退回人员(用户表)-用户状态(BJ:编辑/TJ:提交/PZ:批准...)
	 */
	...
	/**
	 * 维修退回人员(用户表)-用户短信验证码创建时间
	 */
	private Date usersmstime;

	/**
	 * 维修退回人员(用户表)-用户微信OpenId
	 */
	private String useropenid;
	
	/**
	 * 维修退回人员(用户表)-用户位置信息(当前位置信息)
	 */
	...
	/**
	 * 根据维修人员退回维修单表的退回时间段查询时使用
	 * 
	 * 查询时间段的开始时间
	 */
	private String selectreturnstarttime;
	 ...
	 * 查询时间段的结束时间
	 */
	private String selectreturnendtime;
	...
	public String getSelectreturnstarttime() {
		return selectreturnstarttime;
	}

	public void setSelectreturnstarttime(String selectreturnstarttime) {
		this.selectreturnstarttime = selectreturnstarttime;
	}

	public String getSelectreturnendtime() {
		return selectreturnendtime;
	}

	public void setSelectreturnendtime(String selectreturnendtime) {
		this.selectreturnendtime = selectreturnendtime;
	}
