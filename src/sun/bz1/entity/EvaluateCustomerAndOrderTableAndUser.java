...
/**
 * 维修人员评价客户表、维修单表、客户ID(被评价用户)(用户表)、维修人员ID(评价用户)(用户表)
 * 
 * 实体类
 * 
...
public class EvaluateCustomerAndOrderTableAndUser {
    ...
    /**
	 * 维修人员评价客户表-评价ID(PJKH+UUID)
	 */
    private String evaluatecustomerid;

    /**
	 * 维修人员评价客户表-客户ID(被评价用户)(YHBG+UUID)
	 */
    private String customeruserid;

    /**
	 * 维修人员评价客户表-维修人员ID(评价用户)(YHBG+UUID)
	 */
    private String serviceuserid;

    /**
	 * 维修人员评价客户表-维修单ID(D+年月日+时分秒+6位随机数)
	 */
	...
	/**
	 * 维修人员评价客户表-评价项ID(WPJX+UUID)多个用,隔开
	 */
	private String evaluatecustomersetupid;

	/**
	 * 维修人员评价客户表-评价项名称多个用,隔开
	 */
	private String evaluatecustomersetupname;

	/**
	 * 维修人员评价客户表-得分用于展示实体星星多个用,隔开
	 */
	...
	public void setEvaluatecustomeropinion(String evaluatecustomeropinion) {
		this.evaluatecustomeropinion = evaluatecustomeropinion;
	}
	...
	public void setEvaluatecustomerremark(String evaluatecustomerremark) {
		this.evaluatecustomerremark = evaluatecustomerremark;
	}
